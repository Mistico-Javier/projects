package dgtic.proyecto.security;

import dgtic.proyecto.security.jwt.JWTAuthenticationFilter;
import dgtic.proyecto.security.jwt.JWTTokenProvider;
import dgtic.proyecto.security.logout.CustomLogoutSuccessHandler;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((authorize) -> authorize
                        .requestMatchers("/css/**", "/favicon.ico", "/**", "/index","login","/token").permitAll()
